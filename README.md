...
The RCDS team has curated a collection of annotated exemplar projects known as [ReCoDE](https://imperialcollegelondon.github.io/ReCoDE-home/) which demonstrate core research computing and data science principles applied to real problems. Each exemplar is a real project created by an Imperial student based on their research. Each exemplar is accompanied by detailed descriptions of how they work, and the design decisions taken when constructing the code. The following exemplar relates to writing an IMperial thesis using LaTeX:

* [**Imperial College London PhD Thesis LaTeX Template**](https://imperialcollegelondon.github.io/ReCoDE-LaTeX-PhD-Template/): This exemplar presents an example LaTeX template for an Imperial PhD thesis. It includes all major sections of a thesis and example content designed to demosntrate common formatting in LaTeX. It includes an approach to bibliogrpahies using Biber. It is a little more advanced than the content of this course.
